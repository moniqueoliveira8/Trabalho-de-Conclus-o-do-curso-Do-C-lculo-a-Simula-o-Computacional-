...
## Resultados completos (Google Drive)

Os arquivos de resultado que ultrapassam o limite de 100 MB do GitHub, incluindo a interpolação 3D das perdas na bobina e a simulação completa com 500 iterações, estão disponíveis no Google Drive:

🔗 [Resultados completos (interpolação da bobina + simulação de 500 iterações)](https://drive.google.com/drive/folders/1HZlIu9CMbwL6XH-2XKduzDLFiGs5-iPu?usp=drive_link)
